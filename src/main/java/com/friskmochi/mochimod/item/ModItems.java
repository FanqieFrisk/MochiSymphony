...
import com.friskmochi.mochimod.item.custom.ModArmorItem;
...
public class ModItems {
    ...
    public static final Item RAIN_HELMET = registerItems("rain_helmet",
            new ModArmorItem(ModArmorMaterials.RAIN, ArmorItem.Type.HELMET,
    ...
    public static final Item RAIN_CHESTPLATE = registerItems("rain_chestplate",
            new ModArmorItem(ModArmorMaterials.RAIN, ArmorItem.Type.CHESTPLATE,
    ...
    public static final Item RAIN_LEGGINGS = registerItems("rain_leggings",
            new ModArmorItem(ModArmorMaterials.RAIN, ArmorItem.Type.LEGGINGS,
    ...
    public static final Item RAIN_BOOTS = registerItems("rain_boots",
            new ModArmorItem(ModArmorMaterials.RAIN, ArmorItem.Type.BOOTS,
    ...
    public static final Item TANGHULU = registerItems("tanghulu",
            new SwordItem(ModToolMaterials.HAWTHORN,new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers
                    (ModToolMaterials.HAWTHORN,3,1f)).food(ModFoodComponents.TANGHULU)));
